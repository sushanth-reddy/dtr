...
function redirect(conformanceStatement) {
  ...
  if (serviceUri.search('3.92.187.150') > 0) {
      authUri = "https://valtest.mettles.com:8443/auth/realms/ClientFhirServer/protocol/openid-connect/auth";
      tokenUri = "https://valtest.mettles.com:8443/auth/realms/ClientFhirServer/protocol/openid-connect/token"
    } else {
